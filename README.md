...
```
  compile 'it.cnr.iit.jscontact:jscontact-tools:0.17.0'
```
...
Version 0.17.0 implements the following draft versions:

* draft-ietf-calext-jscontact-14
* draft-ietf-calext-jscontact-vcard-12
