 ...
 */
@NoArgsConstructor
public class VCardUnconvertedPropsSerializer extends JsonSerializer<VCardUnconvertedProperty[]> {

    @Override
    public void serialize(
            VCardUnconvertedProperty[] vCardProps, JsonGenerator jgen, SerializerProvider provider)
            throws IOException {
        ...
        for (VCardUnconvertedProperty vCardProp : vCardProps) {
            jgen.writeStartArray();
