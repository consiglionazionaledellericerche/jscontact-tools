...
import it.cnr.iit.jscontact.tools.constraints.validators.RelationTypeValidator;
...
@Documented
public @interface RelationTypeConstraint {

    String message() default "invalid relation type in Relation";
