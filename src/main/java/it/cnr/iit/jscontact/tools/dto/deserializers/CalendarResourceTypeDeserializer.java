 ...
 */
@NoArgsConstructor
public class CalendarResourceTypeDeserializer extends JsonDeserializer<CalendarResourceType> {

    @Override
    public CalendarResourceType deserialize(JsonParser jp, DeserializationContext ctxt)
            throws IOException {
