...
/**
 * Custom JSON serializer for the TitleType value.
 *
 * @author Mario Loffredo
 */
@NoArgsConstructor
public class TitleTypeSerializer extends JsonSerializer<TitleType> {

    @Override
    public void serialize(
            TitleType kind, JsonGenerator jgen, SerializerProvider provider)
            throws IOException {
