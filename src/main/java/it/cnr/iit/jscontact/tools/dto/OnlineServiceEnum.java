 ...
 */
@AllArgsConstructor
public enum OnlineServiceEnum implements IsExtensibleEnum {
    ...
    @JsonCreator
    public static OnlineServiceEnum getEnum(String value) throws IllegalArgumentException {
        return (value == null) ? null : EnumUtils.getEnum(OnlineServiceEnum.class, value);
    }
