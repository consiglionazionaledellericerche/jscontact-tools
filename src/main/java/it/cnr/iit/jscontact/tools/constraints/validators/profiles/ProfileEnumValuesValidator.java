...
public class ProfileEnumValuesValidator implements ConstraintValidator<ProfileEnumValuesConstraint, ExtensibleEnumType> {

    public void initialize(ProfileEnumValuesConstraint constraintAnnotation) {
    }

    public boolean isValid(ExtensibleEnumType type, ConstraintValidatorContext context) {
