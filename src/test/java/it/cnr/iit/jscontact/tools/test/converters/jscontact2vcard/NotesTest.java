...
public class NotesTest extends JSContact2VCardTest {
    ...
    public void testNotes2() throws IOException, CardException {
        ...
        String jscard="{" +
                ...
                "}";
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        assertTrue("testNotes2 - 1",vcard.getNotes().size() == 3);
        ...
        assertTrue("testNotes2 - 5",vcard.getNotes().get(1).getValue().equals("Questo numero di fax è operativo dalle 8.00 alle 17.15, Lun-Ven"));
        assertTrue("testNotes2 - 6",vcard.getNotes().get(1).getLanguage().equals("it"));
        assertTrue("testNotes2 - 7",vcard.getNotes().get(1).getAltId().equals("1"));
        assertTrue("testNotes2 - 8",vcard.getNotes().get(2).getValue().equals("This is another note"));
        assertTrue("testNotes2 - 9",vcard.getNotes().get(2).getLanguage() == null);
        assertTrue("testNotes2 - 10",vcard.getNotes().get(2).getAltId() == null);
    }
    ...
    public void testNotes3() throws IOException, CardException {
        ...
        String jscard="{" +
                ...
                "\"notes\":[" +
                    ...
                    "{" +
                        "\"value\": \"This is another note\"," +
                        "\"localizations\": { \"it\":\"Questa è un'altra nota\" }" +
                    "}" +
                "]" +
                "}";
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        ...
        assertTrue("testNotes3 - 5",vcard.getNotes().get(1).getValue().equals("Questo numero di fax è operativo dalle 8.00 alle 17.15, Lun-Ven"));
        assertTrue("testNotes3 - 6",vcard.getNotes().get(1).getLanguage().equals("it"));
        assertTrue("testNotes3 - 7",vcard.getNotes().get(1).getAltId().equals("1"));
        assertTrue("testNotes3 - 8",vcard.getNotes().get(2).getValue().equals("This is another note"));
        assertTrue("testNotes3 - 9",vcard.getNotes().get(2).getLanguage() == null);
        assertTrue("testNotes3 - 10",vcard.getNotes().get(2).getAltId().equals("2"));
