...
public class PreferredLanguagesTest extends JCard2JSContactTest {
    ...
    public void testPreferredLanguages2() throws CardException {
        ...
        assertEquals("testPreferredLanguages2 - 8", "en", jsCard.getPreferredLanguages().get("LANG-1").getLanguage());
        assertEquals("testPreferredLanguages2 - 9", "fr", jsCard.getPreferredLanguages().get("LANG-2").getLanguage());
        assertEquals("testPreferredLanguages2 - 10", "fr", jsCard.getPreferredLanguages().get("LANG-3").getLanguage());
    }
