...
public class JCardGroupTest extends JCard2JSContactTest {
    ...
    public void testJCardGroup1() throws CardException {
        ...
        assertTrue("testJCardGroup1 - 3", jsCardGroup.getKind().isGroup());
        assertTrue("testJCardGroup1 - 4",StringUtils.isNotEmpty(jsCardGroup.getUid()));
        assertEquals("testJCardGroup1 - 5", "The Doe family", jsCardGroup.getFullName());
    ...
    public void testJCardGroup2() throws CardException {
        ...
        assertTrue("testJCardGroup2 - 3", jsCardGroup.getKind().isGroup());
        assertTrue("testJCardGroup2 - 4",StringUtils.isNotEmpty(jsCardGroup.getUid()));
        assertEquals("testJCardGroup2 - 5", "Funky distribution list", jsCardGroup.getFullName());
    ...
    public void testJCardGroup3() throws CardException {
        ...
        assertTrue("testJCardGroup3 - 3", jsCardGroup.getKind().isGroup());
        assertTrue("testJCardGroup3 - 4",StringUtils.isNotEmpty(jsCardGroup.getUid()));
        assertEquals("testJCardGroup3 - 5", "The Doe family", jsCardGroup.getFullName());
    ...
    public void testJCardGroup4() throws CardException {
        ...
        Card jsCardGroup = jsCards.get(0);
        assertTrue("testJCardGroup4 - 3", jsCardGroup.getKind().isGroup());
        assertTrue("testJCardGroup4 - 4",StringUtils.isNotEmpty(jsCardGroup.getUid()));
        assertEquals("testJCardGroup4 - 5", "Funky distribution list", jsCardGroup.getFullName());
