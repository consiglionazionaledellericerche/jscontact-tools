...
public class VCardTest extends RoundtripTest {
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertEquals("testCompleteVCard1 - 1", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    ...
    public void testCompleteVCard2() throws IOException, CardException {
        ...
        pruneVCard(vcard2);
        System.out.println(Ezvcard.write(vcard2).go());
        assertEquals("testCompleteVCard2 - 1", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    }
    ...
    public void testCompleteVCard3() throws IOException, CardException {
        ...
        pruneVCard(vcard2);
        System.out.println(Ezvcard.write(vcard2).go());
        assertEquals("testCompleteVCard1 - 3", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    }
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        pruneVCard(vcard2);
        System.out.println(Ezvcard.write(vcard2).go());
        assertEquals("testCompleteVCard1 - 4", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    }
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        pruneVCard(vcard2);
        System.out.println(Ezvcard.write(vcard2).go());
        assertEquals("testCompleteVCard5 - 1", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    }
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        pruneVCard(vcard2);
        System.out.println(Ezvcard.write(vcard2).go());
        assertEquals("testCompleteVCard6 - 1", vcard2, (Ezvcard.parse(vcard).register(new ExtendedAddressScribe()).register(new ExtendedStructuredNameScribe()).all()).get(0));
    }
