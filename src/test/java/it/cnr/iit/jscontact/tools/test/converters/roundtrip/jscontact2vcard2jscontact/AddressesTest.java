...
public class AddressesTest extends RoundtripTest {
    ...
    public void testAddresses1() throws IOException, CardException {
        ...
        assertEquals("testAddresses1 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses2() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses2 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses3() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses3 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses4() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses4 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses5() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses5 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses6() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses6 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses7() throws IOException, CardException {
        ...
        String jscard = "{" +
                ...
                "\"addresses\":{" +
                    "\"ADR-1\": {" +
                        "\"@type\":\"Address\"," +
                        "\"street\":[{\"@type\":\"StreetComponent\",\"type\":\"name\", \"value\":\"Oak St\"}, {\"@type\":\"NameComponent\",\"type\":\"number\", \"value\":\"54321\"}]," +
                        "\"locality\":\"Reston\"," +
                        "\"region\":\"VA\"," +
                        "\"country\":\"USA\"," +
                        "\"postcode\":\"20190\"," +
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses7 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses8() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses8 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses9() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses9 - 1", jscard2, Card.toCard(jscard));
    }
    ...
    public void testAddresses10() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        Card jscard2 = (Card) vCard2JSContact.convert(vcard).get(0);
        assertEquals("testAddresses10 - 1", jscard2, Card.toCard(jscard));
    }
