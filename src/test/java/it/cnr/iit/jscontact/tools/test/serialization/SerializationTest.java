...
public class SerializationTest {
    ...
    public void testSerialization5() throws IOException, CardException {
        ...
        String serialized = Card.toJson(jsCard);
        assertEquals("testSerialization5", "{\"@type\":\"Card\",\"version\":\"2.0\",\"uid\":\"549e9dd2-ecb1-46af-8df1-09e98329d0ff\",\"name\":{\"@type\":\"Name\",\"full\":\"test\"},\"vCard\":{\"@type\":\"VCard\",\"properties\":[[\"myext\",{},\"text\",\"extvalue\"]]}}", serialized);
