...
public class PhoneTest extends RoundtripTest {
    ...
    public void testPhone1() throws CardException {
        ...
        pruneVCard(vcard2);
        assertEquals("testPhone1 - 1", vcard2, VCardReader.parse(vcard).get(0));    }
    ...
    public void testPhone2() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone2 - 1", vcard2, VCardReader.parse(vcard).get(0));
    }
    ...
    public void testPhone3() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone3 - 1", vcard2, VCardReader.parse(vcard).get(0));
    ...
    public void testPhone4() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone4 - 1", vcard2, VCardReader.parse(vcard).get(0));
    }
    ...
    public void testPhone5() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone5 - 1", vcard2, VCardReader.parse(vcard).get(0));
    ...
    public void testPhone6() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone6 - 1", vcard2, VCardReader.parse(vcard).get(0));
    ...
    public void testPhone7() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone7 - 1", vcard2, VCardReader.parse(vcard).get(0));
    ...
    public void testPhone8() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone8 - 1", vcard2, VCardReader.parse(vcard).get(0));
    ...
    public void testPhone9() throws CardException {
        ...
        VCard vcard2 = jsContact2VCard.convert(jsCard).get(0);
        pruneVCard(vcard2);
        assertEquals("testPhone9 - 1", vcard2, VCardReader.parse(vcard).get(0));
