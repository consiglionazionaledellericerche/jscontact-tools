...
public class TitlesTest extends JSContact2VCardTest {
    ...
    public void testTitles1() throws IOException, CardException {
        ...
        assertEquals("testTitles1 - 8", "TITLE-1", vcard.getTitles().get(0).getParameter(VCardParamEnum.JSID.getValue()));
    }
    ...
    public void testTitles2() throws IOException, CardException {
        ...
        assertEquals("testTitles2 - 11", "TITLE-1", vcard.getTitles().get(0).getParameter(VCardParamEnum.JSID.getValue()));
        assertEquals("testTitles2 - 12", "TITLE-2", vcard.getTitles().get(2).getParameter(VCardParamEnum.JSID.getValue()));
    }
    ...
    public void testTitles3() throws IOException, CardException {
        ...
        assertEquals("testTitles3 - 14", "TITLE-1", vcard.getTitles().get(0).getParameter(VCardParamEnum.JSID.getValue()));
        assertEquals("testTitles3 - 16", "TITLE-2", vcard.getTitles().get(2).getParameter(VCardParamEnum.JSID.getValue()));
    }
    ...
    public void testTitlesAndRoles() throws IOException, CardException {
        ...
        assertEquals("testTitlesAndRoles - 15", "TITLE-1", vcard.getTitles().get(0).getParameter(VCardParamEnum.JSID.getValue()));
        assertEquals("testTitlesAndRoles - 16", "TITLE-2", vcard.getRoles().get(0).getParameter(VCardParamEnum.JSID.getValue()));
    }
