...
public class OnlineTest extends JCard2JSContactTest {
    ...
    public void testOnlineValid1() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid1 - 7",jsCard.getOnline().get("XMPP-1").isImpp());
    }
    ...
    public void testOnlineValid2() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid2 - 3",jsCard.getOnline().get("SOURCE-1").isDirectorySource());
        ...
        assertTrue("testOnlineValid2 - 6",jsCard.getOnline().get("SOURCE-1").hasNoContext());
    }
    ...
    public void testOnlineValid4() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid4 - 3",jsCard.getOnline().get("LOGO-1").isLogo());
        ...
        assertTrue("testOnlineValid4 - 6",jsCard.getOnline().get("LOGO-1").hasNoContext());
    }
    ...
    public void testOnlineValid5() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid5 - 3",jsCard.getOnline().get("CONTACT-URI-1").isContactUri());
        ...
        assertTrue("testOnlineValid5 - 6",jsCard.getOnline().get("CONTACT-URI-1").hasNoContext());
    }
    ...
    public void testOnlineValid6() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid6 - 3",jsCard.getOnline().get("ORG-DIRECTORY-1").isDirectory());
        assertTrue("testOnlineValid6 - 4",jsCard.getOnline().get("ORG-DIRECTORY-1").getPref() == null);
        assertTrue("testOnlineValid6 - 5",jsCard.getOnline().get("ORG-DIRECTORY-1").getMediaType() == null);
        assertTrue("testOnlineValid6 - 6",jsCard.getOnline().get("ORG-DIRECTORY-1").hasNoContext());
        assertTrue("testOnlineValid6 - 7",jsCard.getOnline().get("ORG-DIRECTORY-2").getResource().equals("ldap://ldap.tech.example/o=Example%20Tech,ou=Engineering"));
        assertTrue("testOnlineValid6 - 8",jsCard.getOnline().get("ORG-DIRECTORY-2").isDirectory());
        assertTrue("testOnlineValid6 - 9",jsCard.getOnline().get("ORG-DIRECTORY-2").getPref() == 1);
        assertTrue("testOnlineValid6 - 10",jsCard.getOnline().get("ORG-DIRECTORY-2").getMediaType() == null);
        assertTrue("testOnlineValid6 - 11",jsCard.getOnline().get("ORG-DIRECTORY-2").hasNoContext());
    }
    ...
    public void testOnlineValid7() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid7 - 3",jsCard.getOnline().get("ORG-DIRECTORY-1").isDirectory());
        assertTrue("testOnlineValid7 - 4",jsCard.getOnline().get("ORG-DIRECTORY-1").getPref() == null);
        assertTrue("testOnlineValid7 - 5",jsCard.getOnline().get("ORG-DIRECTORY-1").getMediaType() == null);
        assertTrue("testOnlineValid7 - 6",jsCard.getOnline().get("ORG-DIRECTORY-1").hasNoContext());
        assertTrue("testOnlineValid7 - 7",jsCard.getOnline().get("ORG-DIRECTORY-2").getResource().equals("ldap://ldap.tech.example/o=Example%20Tech,ou=Engineering"));
        assertTrue("testOnlineValid7 - 8",jsCard.getOnline().get("ORG-DIRECTORY-2").isDirectory());
        assertTrue("testOnlineValid7 - 9",jsCard.getOnline().get("ORG-DIRECTORY-2").getPref() == 1);
        assertTrue("testOnlineValid7 - 10",jsCard.getOnline().get("ORG-DIRECTORY-2").getMediaType() == null);
        assertTrue("testOnlineValid7 - 11",jsCard.getOnline().get("ORG-DIRECTORY-2").hasNoContext());
    }
    ...
    public void testOnlineValid8() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid8 - 3",jsCard.getOnline().get("SOUND-1").isAudio());
    ...
    public void testOnlineValid9() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid9 - 2",jsCard.getOnline().get("URI-1").getResource().equals("http://example.org/restaurant.french/~chezchic.htm"));
        assertTrue("testOnlineValid9 - 3",jsCard.getOnline().get("URI-1").isUri());
        assertTrue("testOnlineValid9 - 4",jsCard.getOnline().get("URI-1").getPref() == null);
        assertTrue("testOnlineValid9 - 5",jsCard.getOnline().get("URI-1").getMediaType().equals(MimeTypeUtils.MIME_TEXT_HTML));
        assertTrue("testOnlineValid9 - 6",jsCard.getOnline().get("URI-1").hasNoContext());
    }
    ...
    public void testOnlineValid10() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid10 - 3",jsCard.getOnline().get("KEY-1").isPublicKey());
    ...
    public void testOnlineValid11() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid11 - 3",jsCard.getOnline().get("FBURL-1").isFreeBusy());
        ...
        assertTrue("testOnlineValid11 - 7",jsCard.getOnline().get("FBURL-2").getResource().equals("ftp://example.com/busy/project-a.ifb"));
        assertTrue("testOnlineValid11 - 8",jsCard.getOnline().get("FBURL-2").isFreeBusy());
        assertTrue("testOnlineValid11 - 9",jsCard.getOnline().get("FBURL-2").getPref() == null);
    ...
    public void testOnlineValid12() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid12 - 2",jsCard.getOnline().get("CALURI-1").getResource().equals("http://cal.example.com/calA"));
        assertTrue("testOnlineValid12 - 3",jsCard.getOnline().get("CALURI-1").isCalendar());
        assertTrue("testOnlineValid12 - 4",jsCard.getOnline().get("CALURI-1").getPref() == 1);
        assertTrue("testOnlineValid12 - 5",jsCard.getOnline().get("CALURI-1").getMediaType() == null);
        assertTrue("testOnlineValid12 - 6",jsCard.getOnline().get("CALURI-1").hasNoContext());
        assertTrue("testOnlineValid12 - 8",jsCard.getOnline().get("CALURI-2").getResource().equals("ftp://ftp.example.com/calA.ics"));
        assertTrue("testOnlineValid12 - 9",jsCard.getOnline().get("CALURI-2").isCalendar());
        assertTrue("testOnlineValid12 - 10",jsCard.getOnline().get("CALURI-2").getPref() == null);
        assertTrue("testOnlineValid12 - 11",jsCard.getOnline().get("CALURI-2").hasNoContext());
        assertTrue("testOnlineValid12 - 12",jsCard.getOnline().get("CALURI-2").getMediaType().equals("text/calendar"));
    }
