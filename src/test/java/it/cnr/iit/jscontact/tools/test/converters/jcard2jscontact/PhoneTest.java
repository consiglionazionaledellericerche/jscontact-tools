...
public class PhoneTest extends JCard2JSContactTest {
    ...
    public void testPhoneValid5() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid5 - 5",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
    ...
    public void testPhoneValid6() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid6 - 5",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
    ...
    public void testPhoneValid8() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid8 - 6",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
