...
public class OnlineServiceTest extends JCard2JSContactTest {
    ...
    public void testOnlineService1() throws CardException {
        ...
        assertTrue("testOnlineService1 - 4",jsCard.getVCard().getConvertedProperties().get("onlineServices/OS-1/uri") != null);
        assertEquals("testOnlineService1 - 5",jsCard.getVCard().getConvertedProperties().get("onlineServices/OS-1/uri").getName(), "impp");
        assertEquals("testOnlineService1 - 6", 1, (int) jsCard.getOnlineServices().get("OS-1").getPref());
    }
