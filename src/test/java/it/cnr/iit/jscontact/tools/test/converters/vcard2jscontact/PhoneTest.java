...
public class PhoneTest extends VCard2JSContactTest {
    ...
    public void testPhoneValid2() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid2 - 4",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testPhoneValid2 - 7",jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testPhoneValid3() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid3 - 4",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.FAX));
    ...
    public void testPhoneValid4() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid4 - 4",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.OTHER));
    ...
    public void testPhoneValid5() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid5 - 6",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testPhoneValid6() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid6 - 6",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.FAX));
    ...
    public void testPhoneValid7() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid7 - 6",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.OTHER));
    ...
    public void testPhoneValid8() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid8 - 7",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testPhoneValid9() throws IOException, CardException {
        ...
        assertTrue("testPhoneValid9 - 3",jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
    }
