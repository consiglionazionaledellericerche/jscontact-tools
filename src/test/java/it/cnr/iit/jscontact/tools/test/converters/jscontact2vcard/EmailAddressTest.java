...
public class EmailAddressTest extends JSContact2VCardTest {
    ...
    public void testEmailAddress1() throws IOException, CardException {
        ...
        assertEquals("testEmailAddress1 - 5", "EMAIL-1", vcard.getEmails().get(0).getParameter(VCardParamEnum.JSID.getValue()));
    }
    ...
    public void testEmailAddress2() throws IOException, CardException {
        ...
        assertEquals("testEmailAddress2 - 9", "EMAIL-1", vcard.getEmails().get(0).getParameter(VCardParamEnum.JSID.getValue()));
        assertEquals("testEmailAddress2 - 10", "EMAIL-2", vcard.getEmails().get(1).getParameter(VCardParamEnum.JSID.getValue()));
    }
