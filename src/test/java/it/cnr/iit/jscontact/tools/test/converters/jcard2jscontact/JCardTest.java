...
//    @Test(expected = JCardException.class)
    ...
    public void testCompleteJCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard1 - 33", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard1 - 34", jsCard.getPhones()[0].getValue().equals("tel:+1-555-555-1234;ext=102"));
        assertTrue("testCompleteJCard1 - 35", jsCard.getPhones()[0].getPref() == 1);
        assertTrue("testCompleteJCard1 - 36", jsCard.getPhones()[0].getContext() == Context.WORK);
        assertTrue("testCompleteJCard1 - 37", jsCard.getPhones()[0].getLabels() == null);
        assertTrue("testCompleteJCard1 - 38", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard1 - 39", jsCard.getPhones()[1].getValue().equals("tel:+1-555-555-4321"));
        assertTrue("testCompleteJCard1 - 40", jsCard.getPhones()[1].getPref() == null);
        assertTrue("testCompleteJCard1 - 41", jsCard.getPhones()[1].getContext() == Context.WORK);
    ...
    public void testCompleteJCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard3 - 11", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteJCard3 - 14", jsCard.getPhones()[1].getType().equals(PhoneType.FAX.getValue()));
    ...
    public void testCompleteJCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard4 - 33", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard4 - 34", jsCard.getPhones()[0].getContext() == Context.WORK);
        assertTrue("testCompleteJCard4 - 35", jsCard.getPhones()[0].getValue().equals("tel:+1-418-656-9254;ext=102"));
        assertTrue("testCompleteJCard4 - 36", jsCard.getPhones()[0].getPref() == 1);
        assertTrue("testCompleteJCard4 - 37", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard4 - 38", jsCard.getPhones()[1].getContext() == Context.WORK);
    ...
    public void testCompleteJCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard5 - 18", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard5 - 19", jsCard.getPhones()[0].getContext() == Context.WORK);
        ...
        assertTrue("testCompleteJCard5 - 22", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteJCard5 - 23", jsCard.getPhones()[1].getContext() == Context.PRIVATE);
