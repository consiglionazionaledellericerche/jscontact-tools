...
public class JCardTest extends JCard2JSContactTest {
    ...
    public void testCompleteJCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard1 - 5", jsCard.getName()[0].getValue().equals("Joe"));
        assertTrue("testCompleteJCard1 - 6", jsCard.getName()[1].isSurname());
        assertTrue("testCompleteJCard1 - 7", jsCard.getName()[1].getValue().equals("User"));
        assertTrue("testCompleteJCard1 - 8", jsCard.getName()[2].isSuffix());
        assertTrue("testCompleteJCard1 - 9", jsCard.getName()[2].getValue().equals("ing. jr"));
        assertTrue("testCompleteJCard1 - 10", jsCard.getName()[3].isSuffix());
        ...
        assertTrue("testCompleteJCard1 - 21", jsCard.getAddresses().get("ADR-1").getStreet().equals("4321 Rue Somewhere"));
        ...
        assertTrue("testCompleteJCard1 - 30", jsCard.getEmails().get("EMAIL-1").hasWork());
        ...
        assertTrue("testCompleteJCard1 - 33", jsCard.getPhones().get("PHONE-1").hasVoice());
        ...
        assertTrue("testCompleteJCard1 - 36", jsCard.getPhones().get("PHONE-1").hasWork());
        assertTrue("testCompleteJCard1 - 37", jsCard.getPhones().get("PHONE-1").getLabel() == null);
        assertTrue("testCompleteJCard1 - 38", jsCard.getPhones().get("PHONE-2").hasVoice());
        ...
        assertTrue("testCompleteJCard1 - 41", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteJCard1 - 50", jsCard.getOnline().get("KEY-1").hasWork());
        ...
        assertTrue("testCompleteJCard1 - 56", jsCard.getOnline().get("URL-1").hasPrivate());
    ...
    public void testCompleteJCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard3 - 11", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteJCard3 - 12", jsCard.getPhones().get("PHONE-1").getContexts().size() == 0);
        assertTrue("testCompleteJCard3 - 13", jsCard.getPhones().get("PHONE-1").getPhone().isEmpty());
        assertTrue("testCompleteJCard3 - 14", jsCard.getPhones().get("PHONE-2").hasFax());
        assertTrue("testCompleteJCard3 - 15", jsCard.getPhones().get("PHONE-2").getContexts().size() == 0);
    ...
    public void testCompleteJCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard4 - 5", jsCard.getName()[0].getValue().equals("Simon"));
        assertTrue("testCompleteJCard4 - 6", jsCard.getName()[1].isSurname());
        assertTrue("testCompleteJCard4 - 7", jsCard.getName()[1].getValue().equals("Perreault"));
        assertTrue("testCompleteJCard4 - 8", jsCard.getName()[2].isSuffix());
        assertTrue("testCompleteJCard4 - 9", jsCard.getName()[2].getValue().equals("ing. jr"));
        assertTrue("testCompleteJCard4 - 10", jsCard.getName()[3].isSuffix());
        ...
        assertTrue("testCompleteJCard4 - 13", jsCard.getAnniversaries()[0].isBirth());
        assertTrue("testCompleteJCard4 - 14", jsCard.getAnniversaries()[0].getDate().isEqual("0000-02-03"));
        assertTrue("testCompleteJCard4 - 15", jsCard.getAnniversaries()[1].isOtherAnniversary());
        assertTrue("testCompleteJCard4 - 16", jsCard.getAnniversaries()[1].getLabel().equals("marriage date"));
        assertTrue("testCompleteJCard4 - 17", jsCard.getAnniversaries()[1].getDate().isEqual("2009-08-08T14:30:00-05:00"));
        ...
        assertTrue("testCompleteJCard4 - 24", jsCard.getAddresses().get("ADR-1").getExtension().equals("Suite D2-630"));
        assertTrue("testCompleteJCard4 - 25", jsCard.getAddresses().get("ADR-1").getStreet().equals("2875 Laurier"));
        ...
        assertTrue("testCompleteJCard4 - 33", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteJCard4 - 34", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteJCard4 - 37", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteJCard4 - 38", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteJCard4 - 45", jsCard.getEmails().get("EMAIL-1").hasWork());
        ...
        assertTrue("testCompleteJCard4 - 48", jsCard.getOnline().get("KEY-1").hasWork());
        ...
        assertTrue("testCompleteJCard4 - 52", jsCard.getOnline().get("URL-1").hasPrivate());
    ...
    public void testCompleteJCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard5 - 5", jsCard.getName()[0].getValue().equals("Mr."));
        assertTrue("testCompleteJCard5 - 6", jsCard.getName()[1].isPersonal());
        ...
        assertTrue("testCompleteJCard5 - 11", jsCard.getTitles().get("TITLE-1").getTitle().getValue().equals("Shrimp Man"));
        ...
        assertTrue("testCompleteJCard5 - 18", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteJCard5 - 19", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteJCard5 - 22", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteJCard5 - 23", jsCard.getPhones().get("PHONE-2").hasPrivate());
        ...
        assertTrue("testCompleteJCard5 - 27", jsCard.getAddresses().get("ADR-1").hasWork());
        assertTrue("testCompleteJCard5 - 28", jsCard.getAddresses().get("ADR-1").getPref() == 1);
        assertTrue("testCompleteJCard5 - 29", jsCard.getAddresses().get("ADR-1").getFullAddress().getValue().equals("100 Waters Edge\nBaytown, LA 30314\nUnited States of America"));
        assertTrue("testCompleteJCard5 - 30", jsCard.getAddresses().get("ADR-1").getStreet().equals("100 Waters Edge"));
        ...
        assertTrue("testCompleteJCard5 - 35", jsCard.getAddresses().get("ADR-2").hasPrivate());
        assertTrue("testCompleteJCard5 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\nBaytown, LA 30314\nUnited States of America"));
        assertTrue("testCompleteJCard5 - 37", jsCard.getAddresses().get("ADR-2").getStreet().equals("42 Plantation St."));
