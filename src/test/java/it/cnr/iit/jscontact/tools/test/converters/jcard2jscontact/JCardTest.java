...
//    @Test(expected = JCardException.class)
    ...
    public void testCompleteJCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard1 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
        ...
        assertTrue("testCompleteJCard1 - 38", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneType.VOICE));
    ...
    public void testCompleteJCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard3 - 11", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
        ...
        assertTrue("testCompleteJCard3 - 14", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneType.FAX));
    ...
    public void testCompleteJCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard4 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
        ...
        assertTrue("testCompleteJCard4 - 37", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneType.VOICE));
    ...
    public void testCompleteJCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard5 - 18", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneType.VOICE));
        ...
        assertTrue("testCompleteJCard5 - 22", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneType.VOICE));
