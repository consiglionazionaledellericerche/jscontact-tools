...
public class JCardTest extends JCard2JSContactTest {
    ...
    public void testCompleteJCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard1 - 4", jsCard.getName()[0].getType() == NameComponentType.PERSONAL);
        assertTrue("testCompleteJCard1 - 5", jsCard.getName()[0].getValue().equals("Joe"));
        assertTrue("testCompleteJCard1 - 6", jsCard.getName()[1].getType() == NameComponentType.SURNAME);
        ...
        assertTrue("testCompleteJCard1 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteJCard1 - 36", jsCard.getPhones().get("PHONE-1").getContexts().containsKey(Context.WORK));
        assertTrue("testCompleteJCard1 - 37", jsCard.getPhones().get("PHONE-1").getLabel() == null);
        assertTrue("testCompleteJCard1 - 38", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testCompleteJCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard3 - 11", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteJCard3 - 14", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.FAX));
    ...
    public void testCompleteJCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard4 - 4", jsCard.getName()[0].getType() == NameComponentType.PERSONAL);
        assertTrue("testCompleteJCard4 - 5", jsCard.getName()[0].getValue().equals("Simon"));
        assertTrue("testCompleteJCard4 - 6", jsCard.getName()[1].getType() == NameComponentType.SURNAME);
        ...
        assertTrue("testCompleteJCard4 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        assertTrue("testCompleteJCard4 - 34", jsCard.getPhones().get("PHONE-1").getContexts().containsKey(Context.WORK));
        ...
        assertTrue("testCompleteJCard4 - 37", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
        assertTrue("testCompleteJCard4 - 38", jsCard.getPhones().get("PHONE-2").getContexts().containsKey(Context.WORK));
    ...
    public void testCompleteJCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteJCard5 - 4", jsCard.getName()[0].getType() == NameComponentType.PREFIX);
        ...
        assertTrue("testCompleteJCard5 - 8", jsCard.getName()[2].getType() == NameComponentType.SURNAME);
        ...
        assertTrue("testCompleteJCard5 - 18", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        assertTrue("testCompleteJCard5 - 19", jsCard.getPhones().get("PHONE-1").getContexts().containsKey(Context.WORK));
        ...
        assertTrue("testCompleteJCard5 - 22", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
        assertTrue("testCompleteJCard5 - 23", jsCard.getPhones().get("PHONE-2").getContexts().containsKey(Context.PRIVATE));
        ...
        assertTrue("testCompleteJCard5 - 27", jsCard.getAddresses().get("ADR-1").getContexts().containsKey(AddressContext.WORK));
        ...
        assertTrue("testCompleteJCard5 - 35", jsCard.getAddresses().get("ADR-2").getContexts().containsKey(AddressContext.PRIVATE));
