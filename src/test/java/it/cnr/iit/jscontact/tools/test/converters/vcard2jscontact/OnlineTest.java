...
public class OnlineTest extends VCard2JSContactTest {
    ...
    public void testOnlineValid6() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid6 - 8",jsCard.getOnline().get("ORG-DIRECTORY-2").getPref() == 1);
        assertTrue("testOnlineValid6 - 9",jsCard.getOnline().get("ORG-DIRECTORY-2").getMediaType() == null);
        assertTrue("testOnlineValid6 - 10",jsCard.getOnline().get("ORG-DIRECTORY-2").isDirectory());
    ...
    public void testOnlineValid7() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid7 - 8",jsCard.getOnline().get("ORG-DIRECTORY-2").getPref() == 1);
        assertTrue("testOnlineValid7 - 9",jsCard.getOnline().get("ORG-DIRECTORY-2").getMediaType() == null);
        assertTrue("testOnlineValid7 - 10",jsCard.getOnline().get("ORG-DIRECTORY-2").hasNoContext());
        assertTrue("testOnlineValid7 - 11",jsCard.getOnline().get("ORG-DIRECTORY-2").isDirectory());
    }
    ...
    public void testOnlineValid12() throws IOException, CardException {
        ...
        assertTrue("testOnlineValid12 - 7",jsCard.getOnline().get("CALURI-2").getResource().equals("ftp://ftp.example.com/calA.ics"));
        assertTrue("testOnlineValid12 - 8",jsCard.getOnline().get("CALURI-2").isCalendar());
        assertTrue("testOnlineValid12 - 9",jsCard.getOnline().get("CALURI-2").getPref() == null);
        assertTrue("testOnlineValid12 - 10",jsCard.getOnline().get("CALURI-2").hasNoContext());
        assertTrue("testOnlineValid12 - 11",jsCard.getOnline().get("CALURI-2").getMediaType().equals("text/calendar"));
    }
