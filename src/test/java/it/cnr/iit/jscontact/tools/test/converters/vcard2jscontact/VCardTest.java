...
//    @Test(expected = JCardException.class)
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard1 - 15", jsCard.getOrganizations().get("organization-1").getName().getValue().equals("Example"));
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses()[1].getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 21", jsCard.getOrganizations().get("organization-1").getName().getValue().equals("Viagenie"));
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 10", jsCard.getOrganizations().get("organization-1").getName().getValue().equals("Bubba Gump Shrimp Co."));
...
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses()[1].getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 72", jsCard.getOrganizations().get("organization-1").getName().getValue().equals("Organization1"));
        assertTrue("testCompleteVCard5 - 72-1", jsCard.getOrganizations().get("organization-1").getUnits()[0].getValue().equals("Department1"));
        assertTrue("testCompleteVCard5 - 73", jsCard.getOrganizations().get("organization-2").getName().getValue().equals("Organization2"));
        assertTrue("testCompleteVCard5 - 73", jsCard.getOrganizations().get("organization-2").getUnits()[0].getValue().equals("Department2"));
