...
//    @Test(expected = JCardException.class)
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 33", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard1 - 38", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
    ...
    public void testCompleteVCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard3 - 11", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard3 - 14", jsCard.getPhones()[1].getType().equals(PhoneType.FAX.getValue()));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 33", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard4 - 37", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 18", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 22", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
...
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 16", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 20", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 24", jsCard.getPhones()[2].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 29", jsCard.getPhones()[3].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 34", jsCard.getPhones()[4].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 38", jsCard.getPhones()[5].getType().equals(PhoneType.FAX.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 42", jsCard.getPhones()[6].getType().equals(PhoneType.FAX.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 46", jsCard.getPhones()[7].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 50", jsCard.getPhones()[8].getType().equals(PhoneType.VOICE.getValue()));
        ...
        assertTrue("testCompleteVCard5 - 54", jsCard.getEmails().size() == 5);
        assertTrue("testCompleteVCard5 - 55", jsCard.getEmails().get("EMAIL-1").getContexts().containsKey(Context.PRIVATE));
        assertTrue("testCompleteVCard5 - 56", jsCard.getEmails().get("EMAIL-1").getEmail().equals("home@example.com"));
        assertTrue("testCompleteVCard5 - 58", jsCard.getEmails().get("EMAIL-2").getContexts().containsKey(Context.WORK));
        assertTrue("testCompleteVCard5 - 59", jsCard.getEmails().get("EMAIL-2").getEmail().equals("work@example.com"));
        assertTrue("testCompleteVCard5 - 60", jsCard.getEmails().get("EMAIL-3").getContexts() == null);
        assertTrue("testCompleteVCard5 - 61", jsCard.getEmails().get("EMAIL-3").getEmail().equals("school@example.com"));
        assertTrue("testCompleteVCard5 - 64", jsCard.getEmails().get("EMAIL-4").getContexts().containsKey(Context.OTHER));
        assertTrue("testCompleteVCard5 - 65", jsCard.getEmails().get("EMAIL-4").getEmail().equals("other@example.com"));
        assertTrue("testCompleteVCard5 - 67", jsCard.getEmails().get("EMAIL-5").getContexts() == null);
        assertTrue("testCompleteVCard5 - 68", jsCard.getEmails().get("EMAIL-5").getEmail().equals("custom@example.com"));
...
//        assertTrue("testCompleteVCard5 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard5 - 142", jsCard.getAddresses().get("ADR-1").getContexts().containsKey(AddressContext.PRIVATE));
        ...
        assertTrue("testCompleteVCard5 - 150", jsCard.getAddresses().get("ADR-2").getContexts().containsKey(AddressContext.WORK));
        ...
        assertTrue("testCompleteVCard5 - 158", jsCard.getAddresses().get("ADR-3").getContexts().containsKey(AddressContext.OTHER));
        ...
        assertTrue("testCompleteVCard5 - 166", jsCard.getAddresses().get("ADR-4").getContexts() == null);
