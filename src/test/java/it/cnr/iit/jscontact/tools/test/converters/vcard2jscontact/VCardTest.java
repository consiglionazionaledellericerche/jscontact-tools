...
//        assertTrue("testCompleteVCard6 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard6 - 90", jsCard.getOnlineServices().size() == 7);
        assertTrue("testCompleteVCard6 - 98", jsCard.getOnlineServices().get("OS-1").getUri().equals("xmpp:gtalk"));
        assertTrue("testCompleteVCard6 - 102", jsCard.getOnlineServices().get("OS-2").getUri().equals("skype:skype"));
        assertTrue("testCompleteVCard6 - 106", jsCard.getOnlineServices().get("OS-3").getUri().equals("ymsgr:yahoo"));
        assertTrue("testCompleteVCard6 - 110", jsCard.getOnlineServices().get("OS-4").getUri().equals("aim:aim"));
        assertTrue("testCompleteVCard6 - 114", jsCard.getOnlineServices().get("OS-5").getUri().equals("xmpp:jabber"));
        assertTrue("testCompleteVCard6 - 118", jsCard.getOnlineServices().get("OS-6").getUri().equals("other:other"));
        assertTrue("testCompleteVCard6 - 122", jsCard.getOnlineServices().get("OS-7").getUri().equals("customtype:custom"));

        assertTrue("testCompleteVCard6 - 124", jsCard.getResources().size() == 4);
