...
public class VCardTest extends VCard2JSContactTest {
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard1 - 4", jsCard.getName()[0].getType() == NameComponentType.PERSONAL);
        assertTrue("testCompleteVCard1 - 5", jsCard.getName()[0].getValue().equals("Joe"));
        assertTrue("testCompleteVCard1 - 6", jsCard.getName()[1].getType() == NameComponentType.SURNAME);
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard1 - 38", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testCompleteVCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard3 - 11", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard3 - 14", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.FAX));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 4", jsCard.getName()[0].getType() == NameComponentType.PERSONAL);
        assertTrue("testCompleteVCard4 - 5", jsCard.getName()[0].getValue().equals("Simon"));
        assertTrue("testCompleteVCard4 - 6", jsCard.getName()[1].getType() == NameComponentType.SURNAME);
        ...
        assertTrue("testCompleteVCard4 - 33", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard4 - 37", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 4", jsCard.getName()[0].getType() == NameComponentType.PREFIX);
        ...
        assertTrue("testCompleteVCard5 - 8", jsCard.getName()[2].getType() == NameComponentType.SURNAME);
        ...
        assertTrue("testCompleteVCard5 - 18", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard5 - 22", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
...
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard6 - 3", jsCard.getName()[0].getType() == NameComponentType.PREFIX);
        ...
        assertTrue("testCompleteVCard6 - 7", jsCard.getName()[2].getType() == NameComponentType.SURNAME);
        assertTrue("testCompleteVCard6 - 8", jsCard.getName()[2].getValue().equals("LastName"));
        assertTrue("testCompleteVCard6 - 9", jsCard.getName()[3].getType() == NameComponentType.ADDITIONAL);
        ...
        assertTrue("testCompleteVCard6 - 16", jsCard.getPhones().get("PHONE-1").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 20", jsCard.getPhones().get("PHONE-2").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 24", jsCard.getPhones().get("PHONE-3").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 29", jsCard.getPhones().get("PHONE-4").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 34", jsCard.getPhones().get("PHONE-5").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 38", jsCard.getPhones().get("PHONE-6").getFeatures().containsKey(PhoneFeature.FAX));
        ...
        assertTrue("testCompleteVCard6 - 42", jsCard.getPhones().get("PHONE-7").getFeatures().containsKey(PhoneFeature.FAX));
        ...
        assertTrue("testCompleteVCard6 - 46", jsCard.getPhones().get("PHONE-8").getFeatures().containsKey(PhoneFeature.VOICE));
        ...
        assertTrue("testCompleteVCard6 - 50", jsCard.getPhones().get("PHONE-9").getFeatures().containsKey(PhoneFeature.VOICE));
