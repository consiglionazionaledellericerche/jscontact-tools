...
//    @Test(expected = JCardException.class)
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard1 - 15", jsCard.getOrganization()[0].getValue().equals("Example"));
        assertTrue("testCompleteVCard1 - 16", jsCard.getJobTitle()[0].getValue().equals("Research Scientist"));
        assertTrue("testCompleteVCard1 - 17", jsCard.getRole()[0].getValue().equals("Project Lead"));
        assertTrue("testCompleteVCard1 - 18", jsCard.getAddresses().length == 2);
        assertTrue("testCompleteVCard1 - 19", jsCard.getAddresses()[0].getFullAddress().getValue().equals("Suite 1234\n4321 Rue Somewhere\nQuebec\nQC\nG1V 2M2\nCanada"));
        assertTrue("testCompleteVCard1 - 20", jsCard.getAddresses()[0].getExtension().equals("Suite 1234"));
        assertTrue("testCompleteVCard1 - 21", jsCard.getAddresses()[0].getStreet().equals("4321 Rue Somewhere"));
        assertTrue("testCompleteVCard1 - 22", jsCard.getAddresses()[0].getLocality().equals("Quebec"));
        assertTrue("testCompleteVCard1 - 23", jsCard.getAddresses()[0].getRegion().equals("QC"));
        assertTrue("testCompleteVCard1 - 24", jsCard.getAddresses()[0].getCountry().equals("Canada"));
        assertTrue("testCompleteVCard1 - 25", jsCard.getAddresses()[0].getPostcode().equals("G1V 2M2"));
        assertTrue("testCompleteVCard1 - 26", jsCard.getAddresses()[0].getCoordinates().equals("geo:46.772673,-71.282945"));
        assertTrue("testCompleteVCard1 - 27", jsCard.getAddresses()[0].getTimeZone().equals("Etc/GMT+5"));
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses()[1].getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        assertTrue("testCompleteVCard1 - 29", jsCard.getEmails().length == 1);
        assertTrue("testCompleteVCard1 - 30", jsCard.getEmails()[0].getContext() == ResourceContext.WORK);
    ...
    public void testCompleteVCard2() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard2 - 5", jsCard.getJobTitle().length == 1);
        assertTrue("testCompleteVCard2 - 6", jsCard.getJobTitle()[0].getValue().equals("事務局長"));
        assertTrue("testCompleteVCard2 - 7", jsCard.getJobTitle()[0].getLanguage().equals("ja"));
        assertTrue("testCompleteVCard2 - 8", jsCard.getJobTitle()[0].getLocalizations().get("en").equals("Secretary General"));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 21", jsCard.getOrganization()[0].getValue().equals("Viagenie"));
        assertTrue("testCompleteVCard4 - 22", jsCard.getAddresses().length == 1);
        assertTrue("testCompleteVCard4 - 23", jsCard.getAddresses()[0].getFullAddress().getValue().equals("Suite D2-630\n2875 Laurier\nQuebec\nQC\nG1V 2M2\nCanada"));
        assertTrue("testCompleteVCard4 - 24", jsCard.getAddresses()[0].getExtension().equals("Suite D2-630"));
        assertTrue("testCompleteVCard4 - 25", jsCard.getAddresses()[0].getStreet().equals("2875 Laurier"));
        assertTrue("testCompleteVCard4 - 26", jsCard.getAddresses()[0].getLocality().equals("Quebec"));
        assertTrue("testCompleteVCard4 - 27", jsCard.getAddresses()[0].getRegion().equals("QC"));
        assertTrue("testCompleteVCard4 - 28", jsCard.getAddresses()[0].getCountry().equals("Canada"));
        assertTrue("testCompleteVCard4 - 29", jsCard.getAddresses()[0].getPostcode().equals("G1V 2M2"));
        assertTrue("testCompleteVCard4 - 30", jsCard.getAddresses()[0].getCoordinates().equals("geo:46.772673,-71.282945"));
        assertTrue("testCompleteVCard4 - 31", jsCard.getAddresses()[0].getTimeZone().equals("Etc/GMT+5"));
        ...
        assertTrue("testCompleteVCard4 - 45", jsCard.getEmails()[0].getContext() == ResourceContext.WORK);
        ...
        Resource[] keys = jsCard.getOnlineKey();
        assertTrue("testCompleteVCard4 - 48", keys[0].getContext() == ResourceContext.WORK);
        ...
        Resource[] urls = jsCard.getOnlineUrl();
        assertTrue("testCompleteVCard4 - 52", urls[0].getContext() == ResourceContext.PRIVATE);
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 10", jsCard.getOrganization()[0].getValue().equals("Bubba Gump Shrimp Co."));
        assertTrue("testCompleteVCard5 - 11", jsCard.getJobTitle()[0].getValue().equals("Shrimp Man"));
        Resource[] photos = jsCard.getOnlinePhoto();
        assertTrue("testCompleteVCard5 - 12", photos[0].getContext() == null);
        assertTrue("testCompleteVCard5 - 13", photos[0].getType().equals(OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 14", photos[0].getLabels().get(LabelKey.PHOTO.getValue()) == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 15", photos[0].getValue().equals("http://www.example.com/dir_photos/my_photo.gif"));
        ...
        assertTrue("testCompleteVCard5 - 23", jsCard.getPhones()[1].getContext() == ResourceContext.PRIVATE);
        ...
        assertTrue("testCompleteVCard5 - 26", jsCard.getAddresses().length == 2);
        assertTrue("testCompleteVCard5 - 27", jsCard.getAddresses()[0].getContext() == AddressContext.WORK);
        assertTrue("testCompleteVCard5 - 28", jsCard.getAddresses()[0].getIsPreferred() == Boolean.TRUE);
//        assertTrue("testCompleteVCard5 - 29", jsCard.getAddresses()[0].getFullAddress().getValue().equals("100 Waters Edge\\nBaytown\\, LA 30314\\nUnited States of America"));
        assertTrue("testCompleteVCard5 - 30", jsCard.getAddresses()[0].getStreet().equals("100 Waters Edge"));
        assertTrue("testCompleteVCard5 - 31", jsCard.getAddresses()[0].getLocality().equals("Baytown"));
        assertTrue("testCompleteVCard5 - 32", jsCard.getAddresses()[0].getRegion().equals("LA"));
        assertTrue("testCompleteVCard5 - 33", jsCard.getAddresses()[0].getCountry().equals("United States of America"));
        assertTrue("testCompleteVCard5 - 34", jsCard.getAddresses()[0].getPostcode().equals("30314"));
        assertTrue("testCompleteVCard5 - 35", jsCard.getAddresses()[1].getContext() == AddressContext.PRIVATE);
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses()[1].getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
        assertTrue("testCompleteVCard5 - 37", jsCard.getAddresses()[1].getStreet().equals("42 Plantation St."));
        assertTrue("testCompleteVCard5 - 38", jsCard.getAddresses()[1].getLocality().equals("Baytown"));
        assertTrue("testCompleteVCard5 - 39", jsCard.getAddresses()[1].getRegion().equals("LA"));
        assertTrue("testCompleteVCard5 - 40", jsCard.getAddresses()[1].getCountry().equals("United States of America"));
        assertTrue("testCompleteVCard5 - 41", jsCard.getAddresses()[1].getPostcode().equals("30314"));
        ...
        assertTrue("testCompleteVCard5 - 44", jsCard.getUpdated().equals("2008-04-24T19:52:43Z"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 21", jsCard.getPhones()[1].getContext() == ResourceContext.WORK);
        ...
        assertTrue("testCompleteVCard5 - 39", jsCard.getPhones()[5].getContext() == ResourceContext.PRIVATE);
        ...
        assertTrue("testCompleteVCard5 - 43", jsCard.getPhones()[6].getContext() == ResourceContext.WORK);
        ...
        assertTrue("testCompleteVCard5 - 55", jsCard.getEmails()[0].getContext() == ResourceContext.PRIVATE);
        ...
        assertTrue("testCompleteVCard5 - 58", jsCard.getEmails()[1].getContext() == ResourceContext.WORK);
        ...
        assertTrue("testCompleteVCard5 - 64", jsCard.getEmails()[3].getContext() == ResourceContext.OTHER);
        ...
        assertTrue("testCompleteVCard5 - 71", jsCard.getOrganization().length == 2);
        assertTrue("testCompleteVCard5 - 72", jsCard.getOrganization()[0].getValue().equals("Organization1;Department1"));
        assertTrue("testCompleteVCard5 - 73", jsCard.getOrganization()[1].getValue().equals("Organization2;Department2"));
        assertTrue("testCompleteVCard5 - 74", jsCard.getJobTitle().length == 2);
        assertTrue("testCompleteVCard5 - 75", jsCard.getJobTitle()[0].getValue().equals("Title1"));
        assertTrue("testCompleteVCard5 - 76", jsCard.getJobTitle()[1].getValue().equals("Title2"));
        assertTrue("testCompleteVCard5 - 77", jsCard.getCategories().length == 1);
        assertTrue("testCompleteVCard5 - 78", jsCard.getCategories()[0].equals("Tag"));
...
//        assertTrue("testCompleteVCard5 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard5 - 84", jsCard.getOnline().length == 14);
        assertTrue("testCompleteVCard5 - 85", Objects.equals(jsCard.getOnline()[0].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 86", jsCard.getOnline()[0].getValue().equals("https://d3m0kzytmr41b1.cloudfront.net/c335e945d1b60edd9d75eb4837c432f637e95c8a"));
        assertTrue("testCompleteVCard5 - 87", jsCard.getOnline()[0].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 88", jsCard.getOnline()[0].getLabels().get("photo") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 89", Objects.equals(jsCard.getOnline()[1].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 90", jsCard.getOnline()[1].getValue().equals("https://d3m0kzytmr41b1.cloudfront.net/c335e945d1b60edd9d75eb4837c432f637e95c8a"));
        assertTrue("testCompleteVCard5 - 91", jsCard.getOnline()[1].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 92", jsCard.getOnline()[1].getLabels().get("photo") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 93", Objects.equals(jsCard.getOnline()[2].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 94", jsCard.getOnline()[2].getValue().equals("https://d2ojpxxtu63wzl.cloudfront.net/static/aa915d1f29f19baf560e5491decdd30a_67c95da9133249fde8b0da7ceebc298bf680117e6f52054f7f5f7a95e8377238"));
        assertTrue("testCompleteVCard5 - 95", jsCard.getOnline()[2].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 96", jsCard.getOnline()[2].getLabels().get("photo") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 97", Objects.equals(jsCard.getOnline()[3].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 98", jsCard.getOnline()[3].getValue().equals("xmpp:gtalk"));
        assertTrue("testCompleteVCard5 - 99", jsCard.getOnline()[3].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 100", jsCard.getOnline()[3].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 101", Objects.equals(jsCard.getOnline()[4].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 102", jsCard.getOnline()[4].getValue().equals("skype:skype"));
        assertTrue("testCompleteVCard5 - 103", jsCard.getOnline()[4].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 104", jsCard.getOnline()[4].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 105", Objects.equals(jsCard.getOnline()[5].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 106", jsCard.getOnline()[5].getValue().equals("ymsgr:yahoo"));
        assertTrue("testCompleteVCard5 - 107", jsCard.getOnline()[5].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 108", jsCard.getOnline()[5].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 109", Objects.equals(jsCard.getOnline()[6].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 110", jsCard.getOnline()[6].getValue().equals("aim:aim"));
        assertTrue("testCompleteVCard5 - 111", jsCard.getOnline()[6].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 112", jsCard.getOnline()[6].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 113", Objects.equals(jsCard.getOnline()[7].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 114", jsCard.getOnline()[7].getValue().equals("xmpp:jabber"));
        assertTrue("testCompleteVCard5 - 115", jsCard.getOnline()[7].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 116", jsCard.getOnline()[7].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 117", Objects.equals(jsCard.getOnline()[8].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 118", jsCard.getOnline()[8].getValue().equals("other:other"));
        assertTrue("testCompleteVCard5 - 119", jsCard.getOnline()[8].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 120", jsCard.getOnline()[8].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 121", Objects.equals(jsCard.getOnline()[9].getType(), OnlineResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard5 - 122", jsCard.getOnline()[9].getValue().equals("customtype:custom"));
        assertTrue("testCompleteVCard5 - 123", jsCard.getOnline()[9].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 124", jsCard.getOnline()[9].getLabels().get("XMPP") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 125", Objects.equals(jsCard.getOnline()[10].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 126", jsCard.getOnline()[10].getValue().equals("http://www.homepage.com"));
        assertTrue("testCompleteVCard5 - 127", jsCard.getOnline()[10].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 128", jsCard.getOnline()[10].getLabels().get("url") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 129", Objects.equals(jsCard.getOnline()[11].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 130", jsCard.getOnline()[11].getValue().equals("http://www.blog.com"));
        assertTrue("testCompleteVCard5 - 131", jsCard.getOnline()[11].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 132", jsCard.getOnline()[11].getLabels().get("url") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 133", Objects.equals(jsCard.getOnline()[12].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 134", jsCard.getOnline()[12].getValue().equals("http://www.other.com"));
        assertTrue("testCompleteVCard5 - 135", jsCard.getOnline()[12].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 136", jsCard.getOnline()[12].getLabels().get("url") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 137", Objects.equals(jsCard.getOnline()[13].getType(), OnlineResourceType.URI.getValue()));
        assertTrue("testCompleteVCard5 - 138", jsCard.getOnline()[13].getValue().equals("http://www.custom.com"));
        assertTrue("testCompleteVCard5 - 139", jsCard.getOnline()[13].getLabels().size() == 1);
        assertTrue("testCompleteVCard5 - 140", jsCard.getOnline()[13].getLabels().get("url") == Boolean.TRUE);
        assertTrue("testCompleteVCard5 - 141", jsCard.getAddresses().length == 4);
        assertTrue("testCompleteVCard5 - 142", jsCard.getAddresses()[0].getContext() == AddressContext.PRIVATE);
        assertTrue("testCompleteVCard5 - 143", jsCard.getAddresses()[0].getFullAddress().getValue().equals("HomeExtended\nHomeStreet\nHomeCity\nHomeState\nHomePostal\nHomeCountry"));
        assertTrue("testCompleteVCard5 - 144", jsCard.getAddresses()[0].getExtension().equals("HomeExtended"));
        assertTrue("testCompleteVCard5 - 145", jsCard.getAddresses()[0].getStreet().equals("HomeStreet"));
        assertTrue("testCompleteVCard5 - 146", jsCard.getAddresses()[0].getLocality().equals("HomeCity"));
        assertTrue("testCompleteVCard5 - 147", jsCard.getAddresses()[0].getRegion().equals("HomeState"));
        assertTrue("testCompleteVCard5 - 148", jsCard.getAddresses()[0].getCountry().equals("HomeCountry"));
        assertTrue("testCompleteVCard5 - 149", jsCard.getAddresses()[0].getPostcode().equals("HomePostal"));
        assertTrue("testCompleteVCard5 - 150", jsCard.getAddresses()[1].getContext() == AddressContext.WORK);
        assertTrue("testCompleteVCard5 - 151", jsCard.getAddresses()[1].getFullAddress().getValue().equals("WorkExtended\nWorkStreet\nWorkCity\nWorkState\nWorkPostal\nWorkCountry"));
        assertTrue("testCompleteVCard5 - 152", jsCard.getAddresses()[1].getExtension().equals("WorkExtended"));
        assertTrue("testCompleteVCard5 - 153", jsCard.getAddresses()[1].getStreet().equals("WorkStreet"));
        assertTrue("testCompleteVCard5 - 154", jsCard.getAddresses()[1].getLocality().equals("WorkCity"));
        assertTrue("testCompleteVCard5 - 155", jsCard.getAddresses()[1].getRegion().equals("WorkState"));
        assertTrue("testCompleteVCard5 - 156", jsCard.getAddresses()[1].getCountry().equals("WorkCountry"));
        assertTrue("testCompleteVCard5 - 157", jsCard.getAddresses()[1].getPostcode().equals("WorkPostal"));
        assertTrue("testCompleteVCard5 - 158", jsCard.getAddresses()[2].getContext() == AddressContext.OTHER);
        assertTrue("testCompleteVCard5 - 159", jsCard.getAddresses()[2].getFullAddress().getValue().equals("OtherExtended\nOtherStreet\nOtherCity\nOtherState\nOtherPostal\nOtherCountry"));
        assertTrue("testCompleteVCard5 - 160", jsCard.getAddresses()[2].getExtension().equals("OtherExtended"));
        assertTrue("testCompleteVCard5 - 161", jsCard.getAddresses()[2].getStreet().equals("OtherStreet"));
        assertTrue("testCompleteVCard5 - 162", jsCard.getAddresses()[2].getLocality().equals("OtherCity"));
        assertTrue("testCompleteVCard5 - 163", jsCard.getAddresses()[2].getRegion().equals("OtherState"));
        assertTrue("testCompleteVCard5 - 164", jsCard.getAddresses()[2].getCountry().equals("OtherCountry"));
        assertTrue("testCompleteVCard5 - 165", jsCard.getAddresses()[2].getPostcode().equals("OtherPostal"));
        assertTrue("testCompleteVCard5 - 166", jsCard.getAddresses()[3].getContext() == null);
        assertTrue("testCompleteVCard5 - 167", jsCard.getAddresses()[3].getFullAddress().getValue().equals("CustomExtended\nCustomStreet\nCustomCity\nCustomState\nCustomPostal\nCustomCountry"));
        assertTrue("testCompleteVCard5 - 168", jsCard.getAddresses()[3].getExtension().equals("CustomExtended"));
        assertTrue("testCompleteVCard5 - 169", jsCard.getAddresses()[3].getStreet().equals("CustomStreet"));
        assertTrue("testCompleteVCard5 - 170", jsCard.getAddresses()[3].getLocality().equals("CustomCity"));
        assertTrue("testCompleteVCard5 - 171", jsCard.getAddresses()[3].getRegion().equals("CustomState"));
        assertTrue("testCompleteVCard5 - 172", jsCard.getAddresses()[3].getCountry().equals("CustomCountry"));
        assertTrue("testCompleteVCard5 - 173", jsCard.getAddresses()[3].getPostcode().equals("CustomPostal"));
