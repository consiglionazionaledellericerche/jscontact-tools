...
public class VCardTest extends VCard2JSContactTest {
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 37", jsCard.getPhones().get("PHONE-1").getDescription() == null);
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 16", jsCard.getAnniversaries().get("ANNIVERSARY-2").getDescription().equals("marriage date"));
        ...
        assertTrue("testCompleteVCard4 - 54", jsCard.getOnline().get("URL-1").getDescription().equals("url"));
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 21", jsCard.getPhones().get("PHONE-1").getDescription() == null);
        ...
        assertTrue("testCompleteVCard5 - 25", jsCard.getPhones().get("PHONE-2").getDescription() == null);
...
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard6 - 19", jsCard.getPhones().get("PHONE-1").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 23", jsCard.getPhones().get("PHONE-2").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 37", jsCard.getPhones().get("PHONE-5").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 41", jsCard.getPhones().get("PHONE-6").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 45", jsCard.getPhones().get("PHONE-7").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 49", jsCard.getPhones().get("PHONE-8").getDescription() == null);
        ...
        assertTrue("testCompleteVCard6 - 53", jsCard.getPhones().get("PHONE-9").getDescription() == null);
...
//        assertTrue("testCompleteVCard6 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard6 - 100", jsCard.getOnline().get("XMPP-1").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 104", jsCard.getOnline().get("XMPP-2").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 108", jsCard.getOnline().get("XMPP-3").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 112", jsCard.getOnline().get("XMPP-4").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 116", jsCard.getOnline().get("XMPP-5").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 120", jsCard.getOnline().get("XMPP-6").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 124", jsCard.getOnline().get("XMPP-7").getDescription().equals("XMPP"));
        ...
        assertTrue("testCompleteVCard6 - 128", jsCard.getOnline().get("URL-1").getDescription().equals("url"));
        ...
        assertTrue("testCompleteVCard6 - 132", jsCard.getOnline().get("URL-2").getDescription().equals("url"));
        ...
        assertTrue("testCompleteVCard6 - 136", jsCard.getOnline().get("URL-3").getDescription().equals("url"));
        ...
        assertTrue("testCompleteVCard6 - 140", jsCard.getOnline().get("URL-4").getDescription().equals("url"));
