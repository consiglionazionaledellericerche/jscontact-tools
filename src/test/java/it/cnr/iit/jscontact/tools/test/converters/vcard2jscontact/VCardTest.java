...
//    @Test(expected = JCardException.class)
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 47", keys[0].getType().equals(ResourceType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard1 - 52", keys[0].getLabel().equals(OnlineLabelKey.KEY.getValue()));
        Resource[] urls = jsCard.getOnlineUrl();
        assertTrue("testCompleteVCard1 - 53", urls[0].getType().equals(ResourceType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard1 - 58", urls[0].getLabel().equals(OnlineLabelKey.URL.getValue()));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 49", keys[0].getType().equals(ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard4 - 50", keys[0].getLabel().equals(OnlineLabelKey.KEY.getValue()));
        ...
        assertTrue("testCompleteVCard4 - 53", urls[0].getType().equals(ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard4 - 54", urls[0].getLabel().equals("url"));
...
//        assertTrue("testCompleteVCard6 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard6 - 88", jsCard.getOnline().length == 11);

        assertTrue("testCompleteVCard6 - 97", Objects.equals(jsCard.getOnline()[0].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 98", jsCard.getOnline()[0].getValue().equals("xmpp:gtalk"));
        assertTrue("testCompleteVCard6 - 100", jsCard.getOnline()[0].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 101", Objects.equals(jsCard.getOnline()[1].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 102", jsCard.getOnline()[1].getValue().equals("skype:skype"));
        assertTrue("testCompleteVCard6 - 104", jsCard.getOnline()[1].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 105", Objects.equals(jsCard.getOnline()[2].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 106", jsCard.getOnline()[2].getValue().equals("ymsgr:yahoo"));
        assertTrue("testCompleteVCard6 - 108", jsCard.getOnline()[2].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 109", Objects.equals(jsCard.getOnline()[3].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 110", jsCard.getOnline()[3].getValue().equals("aim:aim"));
        assertTrue("testCompleteVCard6 - 112", jsCard.getOnline()[3].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 113", Objects.equals(jsCard.getOnline()[4].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 114", jsCard.getOnline()[4].getValue().equals("xmpp:jabber"));
        assertTrue("testCompleteVCard6 - 116", jsCard.getOnline()[4].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 117", Objects.equals(jsCard.getOnline()[5].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 118", jsCard.getOnline()[5].getValue().equals("other:other"));
        assertTrue("testCompleteVCard6 - 120", jsCard.getOnline()[5].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 121", Objects.equals(jsCard.getOnline()[6].getType(), ResourceType.USERNAME.getValue()));
        assertTrue("testCompleteVCard6 - 122", jsCard.getOnline()[6].getValue().equals("customtype:custom"));
        assertTrue("testCompleteVCard6 - 124", jsCard.getOnline()[6].getLabel().equals("XMPP"));
        assertTrue("testCompleteVCard6 - 125", Objects.equals(jsCard.getOnline()[7].getType(), ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard6 - 126", jsCard.getOnline()[7].getValue().equals("http://www.homepage.com"));
        assertTrue("testCompleteVCard6 - 128", jsCard.getOnline()[7].getLabel().equals("url"));
        assertTrue("testCompleteVCard6 - 129", Objects.equals(jsCard.getOnline()[8].getType(), ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard6 - 130", jsCard.getOnline()[8].getValue().equals("http://www.blog.com"));
        assertTrue("testCompleteVCard6 - 132", jsCard.getOnline()[8].getLabel().equals("url"));
        assertTrue("testCompleteVCard6 - 133", Objects.equals(jsCard.getOnline()[9].getType(), ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard6 - 134", jsCard.getOnline()[9].getValue().equals("http://www.other.com"));
        assertTrue("testCompleteVCard6 - 136", jsCard.getOnline()[9].getLabel().equals("url"));
        assertTrue("testCompleteVCard6 - 137", Objects.equals(jsCard.getOnline()[10].getType(), ResourceType.URI.getValue()));
        assertTrue("testCompleteVCard6 - 138", jsCard.getOnline()[10].getValue().equals("http://www.custom.com"));
        assertTrue("testCompleteVCard6 - 140", jsCard.getOnline()[10].getLabel().equals("url"));
