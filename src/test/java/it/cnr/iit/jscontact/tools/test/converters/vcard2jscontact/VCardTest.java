...
public class VCardTest extends VCard2JSContactTest {
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard1 - 5", jsCard.getName()[0].getValue().equals("Joe"));
        assertTrue("testCompleteVCard1 - 6", jsCard.getName()[1].isSurname());
        assertTrue("testCompleteVCard1 - 7", jsCard.getName()[1].getValue().equals("User"));
        assertTrue("testCompleteVCard1 - 8", jsCard.getName()[2].isSuffix());
        assertTrue("testCompleteVCard1 - 9", jsCard.getName()[2].getValue().equals("ing. jr"));
        assertTrue("testCompleteVCard1 - 10", jsCard.getName()[3].isSuffix());
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 30", jsCard.getEmails().get("EMAIL-1").hasWork());
        ...
        assertTrue("testCompleteVCard1 - 33", jsCard.getPhones().get("PHONE-1").hasVoice());
        ...
        assertTrue("testCompleteVCard1 - 36", jsCard.getPhones().get("PHONE-1").hasWork());
        assertTrue("testCompleteVCard1 - 37", jsCard.getPhones().get("PHONE-1").getLabel() == null);
        assertTrue("testCompleteVCard1 - 38", jsCard.getPhones().get("PHONE-2").hasVoice());
        ...
        assertTrue("testCompleteVCard1 - 41", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteVCard1 - 47", jsCard.getOnline().get("KEY-1").isUri());
        ...
        assertTrue("testCompleteVCard1 - 50", jsCard.getOnline().get("KEY-1").hasWork());
        ...
        assertTrue("testCompleteVCard1 - 56", jsCard.getOnline().get("URL-1").hasPrivate());
    ...
    public void testCompleteVCard3() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard3 - 11", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteVCard3 - 12", jsCard.getPhones().get("PHONE-1").getContexts().size() == 0);
        assertTrue("testCompleteVCard3 - 13", jsCard.getPhones().get("PHONE-1").getPhone().isEmpty());
        assertTrue("testCompleteVCard3 - 14", jsCard.getPhones().get("PHONE-2").hasFax());
        assertTrue("testCompleteVCard3 - 15", jsCard.getPhones().get("PHONE-2").getContexts().size() == 0);
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 5", jsCard.getName()[0].getValue().equals("Simon"));
        assertTrue("testCompleteVCard4 - 6", jsCard.getName()[1].isSurname());
        assertTrue("testCompleteVCard4 - 7", jsCard.getName()[1].getValue().equals("Perreault"));
        assertTrue("testCompleteVCard4 - 8", jsCard.getName()[2].isSuffix());
        ...
        assertTrue("testCompleteVCard4 - 33", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteVCard4 - 34", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteVCard4 - 37", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteVCard4 - 38", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteVCard4 - 45", jsCard.getEmails().get("EMAIL-1").hasWork());
        ...
        assertTrue("testCompleteVCard4 - 48", jsCard.getOnline().get("KEY-1").hasWork());
        ...
        assertTrue("testCompleteVCard4 - 52", jsCard.getOnline().get("URL-1").hasPrivate());
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 5", jsCard.getName()[0].getValue().equals("Mr."));
        assertTrue("testCompleteVCard5 - 6", jsCard.getName()[1].isPersonal());
        ...
        assertTrue("testCompleteVCard5 - 18", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteVCard5 - 19", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteVCard5 - 22", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteVCard5 - 23", jsCard.getPhones().get("PHONE-2").hasPrivate());
        ...
        assertTrue("testCompleteVCard5 - 27", jsCard.getAddresses().get("ADR-1").hasWork());
...
//        assertTrue("testCompleteVCard5 - 29", jsCard.getAddresses().get("ADR-1").getFullAddress().getValue().equals("100 Waters Edge\\nBaytown\\, LA 30314\\nUnited States of America"));
        ...
        assertTrue("testCompleteVCard5 - 35", jsCard.getAddresses().get("ADR-2").hasPrivate());
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard6 - 5", jsCard.getName()[1].isPersonal());
        assertTrue("testCompleteVCard6 - 6", jsCard.getName()[1].getValue().equals("FirstName"));
        assertTrue("testCompleteVCard6 - 7", jsCard.getName()[2].isSurname());
        assertTrue("testCompleteVCard6 - 8", jsCard.getName()[2].getValue().equals("LastName"));
        assertTrue("testCompleteVCard6 - 9", jsCard.getName()[3].isAdditional());
        assertTrue("testCompleteVCard6 - 10", jsCard.getName()[3].getValue().equals("MiddleName"));
        ...
        assertTrue("testCompleteVCard6 - 16", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteVCard6 - 17", jsCard.getPhones().get("PHONE-1").hasPrivate());
        ...
        assertTrue("testCompleteVCard6 - 20", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteVCard6 - 21", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteVCard6 - 24", jsCard.getPhones().get("PHONE-3").hasVoice());
        assertTrue("testCompleteVCard6 - 25", jsCard.getPhones().get("PHONE-3").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 29", jsCard.getPhones().get("PHONE-4").hasVoice());
        assertTrue("testCompleteVCard6 - 30", jsCard.getPhones().get("PHONE-4").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 34", jsCard.getPhones().get("PHONE-5").hasVoice());
        assertTrue("testCompleteVCard6 - 35", jsCard.getPhones().get("PHONE-5").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 38", jsCard.getPhones().get("PHONE-6").hasFax());
        assertTrue("testCompleteVCard6 - 39", jsCard.getPhones().get("PHONE-6").hasPrivate());
        ...
        assertTrue("testCompleteVCard6 - 42", jsCard.getPhones().get("PHONE-7").hasFax());
        assertTrue("testCompleteVCard6 - 43", jsCard.getPhones().get("PHONE-7").hasWork());
        ...
        assertTrue("testCompleteVCard6 - 46", jsCard.getPhones().get("PHONE-8").hasVoice());
        assertTrue("testCompleteVCard6 - 47", jsCard.getPhones().get("PHONE-8").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 50", jsCard.getPhones().get("PHONE-9").hasVoice());
        assertTrue("testCompleteVCard6 - 51", jsCard.getPhones().get("PHONE-9").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 55", jsCard.getEmails().get("EMAIL-1").hasPrivate());
        assertTrue("testCompleteVCard6 - 56", jsCard.getEmails().get("EMAIL-1").getEmail().equals("home@example.com"));
        assertTrue("testCompleteVCard6 - 58", jsCard.getEmails().get("EMAIL-2").hasWork());
        assertTrue("testCompleteVCard6 - 59", jsCard.getEmails().get("EMAIL-2").getEmail().equals("work@example.com"));
        assertTrue("testCompleteVCard6 - 60", jsCard.getEmails().get("EMAIL-3").getContexts().size() == 0);
        ...
        assertTrue("testCompleteVCard6 - 67", jsCard.getEmails().get("EMAIL-5").getContexts().size() == 0);
...
//        assertTrue("testCompleteVCard6 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard6 - 101", jsCard.getOnline().get("XMPP-2").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 105", jsCard.getOnline().get("XMPP-3").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 109", jsCard.getOnline().get("XMPP-4").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 113", jsCard.getOnline().get("XMPP-5").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 117", jsCard.getOnline().get("XMPP-6").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 121", jsCard.getOnline().get("XMPP-7").isUsername());
        ...
        assertTrue("testCompleteVCard6 - 125", jsCard.getOnline().get("URL-1").isUri());
        ...
        assertTrue("testCompleteVCard6 - 129", jsCard.getOnline().get("URL-2").isUri());
        ...
        assertTrue("testCompleteVCard6 - 133", jsCard.getOnline().get("URL-3").isUri());
        ...
        assertTrue("testCompleteVCard6 - 137", jsCard.getOnline().get("URL-4").isUri());
        ...
        assertTrue("testCompleteVCard6 - 142", jsCard.getAddresses().get("ADR-1").hasPrivate());
        ...
        assertTrue("testCompleteVCard6 - 150", jsCard.getAddresses().get("ADR-2").hasWork());
        ...
        assertTrue("testCompleteVCard6 - 166", jsCard.getAddresses().get("ADR-4").getContexts().size() == 0);
