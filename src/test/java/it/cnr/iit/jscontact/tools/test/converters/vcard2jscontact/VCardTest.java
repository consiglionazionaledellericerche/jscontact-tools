...
//    @Test(expected = JCardException.class)
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
        ...
        assertTrue("testCompleteVCard1 - 47", keys[0].getType().equals(OnlineType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard1 - 53", urls[0].getType().equals(OnlineType.URI.getValue()));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 49", keys[0].getType().equals(OnlineType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard4 - 53", urls[0].getType().equals(OnlineType.URI.getValue()));
...
//        assertTrue("testCompleteVCard6 - 80", jsCard.getNotes()[0].equals("Notes line 1\nNotes line 2"));
        ...
        assertTrue("testCompleteVCard6 - 97", Objects.equals(jsCard.getOnline()[0].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 101", Objects.equals(jsCard.getOnline()[1].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 105", Objects.equals(jsCard.getOnline()[2].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 109", Objects.equals(jsCard.getOnline()[3].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 113", Objects.equals(jsCard.getOnline()[4].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 117", Objects.equals(jsCard.getOnline()[5].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 121", Objects.equals(jsCard.getOnline()[6].getType(), OnlineType.USERNAME.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 125", Objects.equals(jsCard.getOnline()[7].getType(), OnlineType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 129", Objects.equals(jsCard.getOnline()[8].getType(), OnlineType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 133", Objects.equals(jsCard.getOnline()[9].getType(), OnlineType.URI.getValue()));
        ...
        assertTrue("testCompleteVCard6 - 137", Objects.equals(jsCard.getOnline()[10].getType(), OnlineType.URI.getValue()));
