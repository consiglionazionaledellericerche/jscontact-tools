...
//    @Test(expected = JCardException.class)
    ...
    public void testCompleteVCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard1 - 15", jsCard.getOrganizations()[0].getValue().equals("Example"));
        assertTrue("testCompleteVCard1 - 16", jsCard.getJobTitles()[0].getValue().equals("Research Scientist"));
 ...
 //       assertTrue("testCompleteVCard1 - 28", jsCard.getAddresses()[1].getFullAddress().getValue().equals("123 Maple Ave\nSuite 90001\nVancouver\nBC\n1239"));
    ...
    public void testCompleteVCard4() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard4 - 21", jsCard.getOrganizations()[0].getValue().equals("Viagenie"));
    ...
    public void testCompleteVCard5() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 10", jsCard.getOrganizations()[0].getValue().equals("Bubba Gump Shrimp Co."));
        assertTrue("testCompleteVCard5 - 11", jsCard.getJobTitles()[0].getValue().equals("Shrimp Man"));
...
//        assertTrue("testCompleteVCard5 - 36", jsCard.getAddresses()[1].getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
    ...
    public void testCompleteVCard6() throws IOException, CardException {
        ...
        assertTrue("testCompleteVCard5 - 71", jsCard.getOrganizations().length == 2);
        assertTrue("testCompleteVCard5 - 72", jsCard.getOrganizations()[0].getValue().equals("Organization1;Department1"));
        assertTrue("testCompleteVCard5 - 73", jsCard.getOrganizations()[1].getValue().equals("Organization2;Department2"));
        assertTrue("testCompleteVCard5 - 74", jsCard.getJobTitles().length == 2);
        assertTrue("testCompleteVCard5 - 75", jsCard.getJobTitles()[0].getValue().equals("Title1"));
        assertTrue("testCompleteVCard5 - 76", jsCard.getJobTitles()[1].getValue().equals("Title2"));
