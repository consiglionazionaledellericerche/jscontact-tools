        ...
        String jscard = "{" +
                        ...
                        "\"addresses\":{" +
                            "\"ADR-1\": {" +
                                ...
                                "\"components\":[{\"@type\":\"StreetComponent\",\"kind\":\"name\", \"value\":\"54321 Oak St\"}]," +
                                "\"locality\":\"Reston\"," +
                                "\"region\":\"VA\"," +
                                "\"country\":\"USA\"," +
                                "\"postcode\":\"20190\"," +
    ...
    public void testAddresses3() throws IOException, CardException {
        ...
        String jscard = "{" +
                ...
                "\"addresses\":{" +
                    ...
                    "\"ADR-2\": {" +
                        "\"@type\":\"Address\"," +
                        "\"components\":[{\"@type\":\"StreetComponent\",\"kind\":\"name\", \"value\":\"12345 Elm St\"}]," +
                        "\"locality\":\"Reston\"," +
                        "\"region\":\"VA\"," +
                        "\"country\":\"USA\"," +
                        "\"postcode\":\"20190\"," +
    ...
    public void testAddresses7() throws IOException, CardException {
        ...
        String jscard = "{" +
                ...
                "\"addresses\":{" +
                    "\"ADR-1\": {" +
                        "\"@type\":\"Address\"," +
                        "\"components\":[{\"@type\":\"StreetComponent\",\"kind\":\"name\", \"value\":\"Oak St\"}, {\"@type\":\"StreetComponent\",\"kind\":\"number\", \"value\":\"54321\"}]," +
                        "\"locality\":\"Reston\"," +
                        "\"region\":\"VA\"," +
                        "\"country\":\"USA\"," +
                        "\"postcode\":\"20190\"," +
        ...
        String jscard = "{" +
                ...
                "\"localizations\":{" +
                    "\"it\":{" +
                        "\"addresses/ADR-1\":{" +
                            "\"@type\":\"Address\"," +
                            "\"components\":[{\"@type\":\"StreetComponent\",\"kind\":\"name\", \"value\":\"Via Moruzzi,1\"}]," +
                            "\"locality\":\"Pisa\"," +
                            "\"country\":\"Italia\"," +
                            "\"postcode\":\"56124\"," +
                            "\"countryCode\":\"IT\"" +
