...
public class AddressesTest extends JSContact2VCardTest {
    ...
    public void testAddresses6() throws IOException, CardException {
        ...
        assertEquals("testAddresses3 - 12", "ADR-1", vcard.getAddresses().get(0).getParameter(PROP_ID_PARAM));
    }
    ...
    public void testAddresses7() throws IOException, CardException {
        ...
        assertEquals("testAddresses8 - 9", "ADR-1", vcard.getAddresses().get(0).getParameter(PROP_ID_PARAM));
    }
    ...
    public void testAddresses8() throws IOException, CardException {
        ...
        assertEquals("testAddresses9 - 10", "ADR-1", vcard.getAddresses().get(0).getParameter(PROP_ID_PARAM));
    }
