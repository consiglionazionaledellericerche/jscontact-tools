...
public class UnconvertedParamsTest extends JSContact2VCardTest {
    ...
    @Test
    public void testFnAndNUnconvertedParams2() throws IOException, CardException {
        ...
        VCard vcard = jsContact2VCard.convert(jscard).get(0);
        assertEquals("testFnAndNUnconvertedParams2 - 1", "Vasiliev Ivan Petrovich Mr.", vcard.getFormattedNames().get(0).getValue());
        assertEquals("testFnAndNUnconvertedParams2 - 2", "true", vcard.getFormattedNames().get(0).getParameter(VCardParamEnum.DERIVED.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 3", "1", vcard.getFormattedNames().get(0).getParameter(VCardParamEnum.PID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 4", "1", vcard.getFormattedNames().get(0).getParameter(VCardParamEnum.ALTID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 5", "Васильев Иван Петрович г-н", vcard.getFormattedNames().get(1).getValue());
        assertEquals("testFnAndNUnconvertedParams2 - 6", "true", vcard.getFormattedNames().get(1).getParameter(VCardParamEnum.DERIVED.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 7", "2", vcard.getFormattedNames().get(1).getParameter(VCardParamEnum.PID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 8", "1", vcard.getFormattedNames().get(1).getParameter(VCardParamEnum.ALTID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 9", "uk-Cyrl", vcard.getFormattedNames().get(1).getParameter(VCardParamEnum.LANGUAGE.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 10", "Vasiliev", vcard.getProperties(ExtendedStructuredName.class).get(0).getFamily());
        assertEquals("testFnAndNUnconvertedParams2 - 11", "Ivan", vcard.getProperties(ExtendedStructuredName.class).get(0).getGiven());
        assertEquals("testFnAndNUnconvertedParams2 - 12", "Petrovich", vcard.getProperties(ExtendedStructuredName.class).get(0).getAdditionalNames().get(0));
        assertEquals("testFnAndNUnconvertedParams2 - 13", "Mr.", vcard.getProperties(ExtendedStructuredName.class).get(0).getPrefixes().get(0));
        assertEquals("testFnAndNUnconvertedParams2 - 14", "3", vcard.getProperties(ExtendedStructuredName.class).get(0).getParameter(VCardParamEnum.PID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 15", "1", vcard.getProperties(ExtendedStructuredName.class).get(0).getParameter(VCardParamEnum.ALTID.getValue()));
        assertEquals("testFnAndNUnconvertedParams2 - 10", "Васильев", vcard.getProperties(ExtendedStructuredName.class).get(1).getFamily());
        assertEquals("testFnAndNUnconvertedParams2 - 11", "Иван", vcard.getProperties(ExtendedStructuredName.class).get(1).getGiven());
        assertEquals("testFnAndNUnconvertedParams2 - 12", "Петрович", vcard.getProperties(ExtendedStructuredName.class).get(1).getAdditionalNames().get(0));
        assertEquals("testFnAndNUnconvertedParams2 - 13", "г-н", vcard.getProperties(ExtendedStructuredName.class).get(1).getPrefixes().get(0));
