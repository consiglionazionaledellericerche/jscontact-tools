...
public class XCardTest extends XCard2JSContactTest {
    ...
    public void testCompleteXCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard1 - 33", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteXCard1 - 34", jsCard.getPhones()[0].getContext() == Context.WORK);
        ...
        assertTrue("testCompleteXCard1 - 37", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteXCard1 - 38", jsCard.getPhones()[1].getContext() == Context.WORK);
    ...
    public void testCompleteXCard2() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard2 - 18", jsCard.getPhones()[0].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteXCard2 - 19", jsCard.getPhones()[0].getContext() == Context.WORK);
        ...
        assertTrue("testCompleteXCard2 - 22", jsCard.getPhones()[1].getType().equals(PhoneType.VOICE.getValue()));
        assertTrue("testCompleteXCard2 - 23", jsCard.getPhones()[1].getContext() == Context.PRIVATE);
