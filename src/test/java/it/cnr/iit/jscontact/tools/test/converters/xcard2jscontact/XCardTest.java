...
public class XCardTest extends XCard2JSContactTest {
    ...
    public void testCompleteXCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard1 - 4", jsCard.getName().getComponents()[1].isGiven());
        assertEquals("testCompleteXCard1 - 5", "Simon", jsCard.getName().getGiven());
        assertTrue("testCompleteXCard1 - 6", jsCard.getName().getComponents()[0].isSurname());
        ...
        assertEquals("testCompleteXCard1 - 19", 1, (int) jsCard.getPreferredLanguages().get("LANG-1").getPref());
        assertEquals("testCompleteXCard1 - 20", 2, (int) jsCard.getPreferredLanguages().get("LANG-2").getPref());
        assertEquals("testCompleteXCard1 - 19", "fr", jsCard.getPreferredLanguages().get("LANG-1").getLanguage());
        assertEquals("testCompleteXCard1 - 20", "en", jsCard.getPreferredLanguages().get("LANG-2").getLanguage());
        ...
        assertEquals("testCompleteXCard1 - 23", "Simon Perreault 2875 boul. Laurier, suite D2-630 Quebec, QC, Canada G1V 2M2", jsCard.getAddresses().get("ADR-1").getFull());
        assertEquals("testCompleteXCard1 - 25", "2875 boul. Laurier, suite D2-630", jsCard.getAddresses().get("ADR-1").getStreetName());
    ...
    public void testCompleteXCard2() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard2 - 4", jsCard.getName().getComponents()[2].isTitle());
        assertEquals("testCompleteXCard2 - 5", "Mr.", jsCard.getName().getComponents()[2].getValue());
        assertTrue("testCompleteXCard2 - 6", jsCard.getName().getComponents()[1].isGiven());
        assertEquals("testCompleteXCard2 - 7", "Forrest", jsCard.getName().getGiven());
        assertTrue("testCompleteXCard2 - 8", jsCard.getName().getComponents()[0].isSurname());
        assertEquals("testCompleteXCard2 - 9", "Gump", jsCard.getName().getSurname());
...
//        assertTrue("testCompleteXCard2 - 29", jsCard.getAddresses().get("ADR-1").getFullAddress().getValue().equals("100 Waters Edge\\nBaytown\\, LA 30314\\nUnited States of America"));
        assertEquals("testCompleteXCard2 - 30", "100 Waters Edge", jsCard.getAddresses().get("ADR-1").getStreetName());
...
//        assertTrue("testCompleteXCard2 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
        assertEquals("testCompleteXCard2 - 37", "42 Plantation St.", jsCard.getAddresses().get("ADR-2").getStreetName());
