...
public class XCardTest extends XCard2JSContactTest {
    ...
    public void testCompleteXCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard1 - 5", jsCard.getName()[0].getValue().equals("Simon"));
        assertTrue("testCompleteXCard1 - 6", jsCard.getName()[1].isSurname());
        assertTrue("testCompleteXCard1 - 7", jsCard.getName()[1].getValue().equals("Perreault"));
        assertTrue("testCompleteXCard1 - 8", jsCard.getName()[2].isSuffix());
        ...
        assertTrue("testCompleteXCard1 - 33", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteXCard1 - 34", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteXCard1 - 37", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteXCard1 - 38", jsCard.getPhones().get("PHONE-2").hasWork());
        ...
        assertTrue("testCompleteXCard1 - 45", jsCard.getEmails().get("EMAIL-1").hasWork());
        ...
        assertTrue("testCompleteXCard1 - 48", jsCard.getOnline().get("KEY-1").hasWork());
        ...
        assertTrue("testCompleteXCard1 - 52", jsCard.getOnline().get("URL-1").hasPrivate());
    ...
    public void testCompleteXCard2() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard2 - 5", jsCard.getName()[0].getValue().equals("Mr."));
        assertTrue("testCompleteXCard2 - 6", jsCard.getName()[1].isPersonal());
        ...
        assertTrue("testCompleteXCard2 - 18", jsCard.getPhones().get("PHONE-1").hasVoice());
        assertTrue("testCompleteXCard2 - 19", jsCard.getPhones().get("PHONE-1").hasWork());
        ...
        assertTrue("testCompleteXCard2 - 22", jsCard.getPhones().get("PHONE-2").hasVoice());
        assertTrue("testCompleteXCard2 - 23", jsCard.getPhones().get("PHONE-2").hasPrivate());
        ...
        assertTrue("testCompleteXCard2 - 27", jsCard.getAddresses().get("ADR-1").hasWork());
...
//        assertTrue("testCompleteXCard2 - 29", jsCard.getAddresses().get("ADR-1").getFullAddress().getValue().equals("100 Waters Edge\\nBaytown\\, LA 30314\\nUnited States of America"));
        ...
        assertTrue("testCompleteXCard2 - 35", jsCard.getAddresses().get("ADR-2").hasPrivate());
//        assertTrue("testCompleteXCard2 - 36", jsCard.getAddresses().get("ADR-2").getFullAddress().getValue().equals("42 Plantation St.\\nBaytown\\, LA 30314\\nUnited States of America"));
        ...
        assertTrue("testCompleteXCard2 - 44", jsCard.getUpdated().compareTo(DateUtils.toCalendar("2008-04-24T19:52:43Z"))==0);
