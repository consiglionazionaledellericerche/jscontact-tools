...
public class XCardTest extends XCard2JSContactTest {
    ...
    public void testCompleteXCard1() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard1 - 3", jsCard.getName().getComponents().length == 4);
        assertTrue("testCompleteXCard1 - 4", jsCard.getName().getComponents()[0].isPersonal());
        assertTrue("testCompleteXCard1 - 5", jsCard.getName().getComponents()[0].getValue().equals("Simon"));
        assertTrue("testCompleteXCard1 - 6", jsCard.getName().getComponents()[1].isSurname());
        assertTrue("testCompleteXCard1 - 7", jsCard.getName().getComponents()[1].getValue().equals("Perreault"));
        assertTrue("testCompleteXCard1 - 8", jsCard.getName().getComponents()[2].isSuffix());
        assertTrue("testCompleteXCard1 - 9", jsCard.getName().getComponents()[2].getValue().equals("ing. jr"));
        assertTrue("testCompleteXCard1 - 10", jsCard.getName().getComponents()[3].isSuffix());
        assertTrue("testCompleteXCard1 - 11", jsCard.getName().getComponents()[3].getValue().equals("M.Sc."));
        ...
        assertTrue("testCompleteXCard1 - 47", jsCard.getResources().size() == 2);
        ...
        assertTrue("testCompleteXCard1 - 50", jsCard.getResources().get("KEY-1").getResource().equals("http://www.viagenie.ca/simon.perreault/simon.asc"));
        ...
        assertTrue("testCompleteXCard1 - 53", jsCard.getResources().get("URI-1").getResource().equals("http://nomis80.org"));
    ...
    public void testCompleteXCard2() throws IOException, CardException {
        ...
        assertTrue("testCompleteXCard2 - 3", jsCard.getName().getComponents().length == 3);
        assertTrue("testCompleteXCard2 - 4", jsCard.getName().getComponents()[0].isPrefix());
        assertTrue("testCompleteXCard2 - 5", jsCard.getName().getComponents()[0].getValue().equals("Mr."));
        assertTrue("testCompleteXCard2 - 6", jsCard.getName().getComponents()[1].isPersonal());
        assertTrue("testCompleteXCard2 - 7", jsCard.getName().getComponents()[1].getValue().equals("Forrest"));
        assertTrue("testCompleteXCard2 - 8", jsCard.getName().getComponents()[2].isSurname());
        assertTrue("testCompleteXCard2 - 9", jsCard.getName().getComponents()[2].getValue().equals("Gump"));
